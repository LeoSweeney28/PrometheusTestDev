...
return {
		...
		Steps = {
			{
				...
				Settings = {
					...
					EnableControlFlowSlotAliasing = true,
					EnableControlFlowIndexIndirection = true,
					EnableControlFlowPayloadPermutation = false,
					EnableVmStringEncoding = true,
					VmStringChunkSize = 24,
			...
			{ Name = "AntiTamper",     Settings = { UseDebug = true, MaxIntegrityChecks = 17, RandomizeErrorMessage = false } },
		...
		Steps = {
			{
				...
				Settings = {
					...
					EnableControlFlowSlotAliasing = true,
					EnableControlFlowIndexIndirection = true,
					EnableControlFlowPayloadPermutation = true,
					EnableControlFlowBlobStorage = true,
					ControlFlowBlobPageSize = 24,
					ControlFlowBlobCacheSize = 8,
					EnableVmStringEncoding = false,
					VmStringChunkSize = 24,
					ControlFlowBytecodeNoise = 1,
					StrictEnvironmentChecks = true,
					DispatcherStyle = "mixed",
	...
	-- VM-focused hardening profile.
	-- Prioritizes VM resilience while avoiding non-VM obfuscation bloat.
	["VMHard"] = {
		LuaVersion = "Lua51",
		VarNamePrefix = "",
		NameGenerator = "MangledShuffled",
		...
		Steps = {
			{
				...
				Settings = {
					...
					EnableControlFlowPayloadPermutation = true,
					EnableControlFlowBlobStorage = true,
					ControlFlowBlobPageSize = 28,
					ControlFlowBlobCacheSize = 16,
					EnableVmStringEncoding = true,
					OptimizeVM = true,
					AdaptiveDifficulty = true,
					JitResistantControlFlow = true,
					EnableEntropyInjection = false,
					VmStringChunkSize = 24,
					ControlFlowBytecodeNoise = 0,
					StrictEnvironmentChecks = true,
					DispatcherStyle = "mixed",
		...
		Steps = {
			...
			},
			{
				...
				Settings = {
					Threshold = 1,
					MaxWrappers = 1,
					IncludeFalseBranchNoise = true,
					WrapInDoBlock = true,
					WrapControlStatements = false,
				},
			},
			...
			},
			{
				...
				Settings = {
					...
					EnableControlFlowBytecode = true,
					EnablePackedControlFlowOperands = true,
					EnableControlFlowSlotAliasing = false,
					EnableControlFlowIndexIndirection = false,
					EnableControlFlowPayloadPermutation = false,
					EnableVmStringEncoding = false,
					VmStringChunkSize = 24,
					ControlFlowBytecodeNoise = 2,
					StrictEnvironmentChecks = false,
					DispatcherStyle = "mixed",
					EqualityDispatchMaxBlocks = 14,
					DispatcherJunkBranches = 1,
					DispatcherJunkProbability = 1,
		...
		Steps = {
			...
			},
			{
				...
				Settings = {
					...
					EnableControlFlowPayloadPermutation = true,
					EnableControlFlowBlobStorage = true,
					ControlFlowBlobPageSize = 32,
					ControlFlowBlobCacheSize = 20,
					EnableVmStringEncoding = true,
					OptimizeVM = true,
					AdaptiveDifficulty = true,
					JitResistantControlFlow = true,
